...
export default async function seedStones(prisma: PrismaClient): Promise<void> {
  await prisma.stone.createMany({
    data: [
      {
        // id: '',
        stoneTypeId: ids.stoneTypes.LAMPING,
        name: 'Rood LP-A',
        alias: 'Bordeaux',
        hex: '#9a0000',
        order: 0,
      ...
      {
        // id: '',
        stoneTypeId: ids.stoneTypes.DOMINO_DAY,
        name: 'Blauw DD-A',
        alias: 'Donkerblauw',
        hex: '#0b0670',
        order: 50,
      ...
      {
        // id: '',
        stoneTypeId: ids.stoneTypes.BULK,
        name: 'Blauw BK-A',
        alias: 'Ice',
        hex: '#b6dde8',
        order: 55,
      ...
      {
        // id: '',
        stoneTypeId: ids.stoneTypes.MR_DOMINO,
        name: 'Rood MD-A',
        alias: 'Bordeaux',
        hex: '#9a0000',
        order: 59,
      ...
      {
        // id: '',
        stoneTypeId: ids.stoneTypes.OTHERS,
        name: 'Mix OV-A',
      ...
      {
        // id: '',
        stoneTypeId: ids.stoneTypes.COLOR_CHANGING,
        name: 'Rood CC-A',
        alias: 'Donkerrood',
        alias2: 'Rood',
        hex: '#ff0000',
      ...
      {
        // id: '',
        stoneTypeId: ids.stoneTypes.DON_DOMINO,
        name: 'Rood DO-A',
        alias: 'Donkerrood',
        hex: '#8d313e',
